...
class StoryWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.alqorut.mystory.TOAST_ACTION"
        const val EXTRA_ITEM = "com.alqorut.mystory.EXTRA_ITEM"

        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            val intent = Intent(context, MyStoryService::class.java)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action != null) {
            if (intent.action == TOAST_ACTION) {
                ...
                toas(context,context.getString(R.string.nomor_gambar,viewIndex))
            }
        }
    }
}
